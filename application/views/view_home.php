	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?php echo base_url('home/katalog');?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url(<?php echo base_url('/assets/images/slide-03.jpg');?>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Hijab Simple Collection 2019
								</span>
							</div>
   ...
   <?php }?>
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="<?php echo base_url('home/detail/');?><?php echo $data['id_product'];?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Quick View
							</a>
						</div>
...
<?php }?>
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="<?php echo base_url('home/katalog');?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
			</div>
		</div>
